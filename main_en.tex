...
\begin{multicols*}{3}
    ...
    \begin{tabular}{m{3cm} l}
        ...
        \texttt{CTRL+w SHIFT $\leftarrow$ }& Move window to the left\\
        \texttt{CTRL+w SHIFT $\rightarrow$ }& Move window to the right \\
        \texttt{CTRL+w SHIFT $\uparrow$ }& Move window up\\
        \texttt{CTRL+w SHIFT $\downarrow$ }& Move window down\\
    \end{tabular}\\

    Of course, you can substitute arrows by h,j,k,l \\
